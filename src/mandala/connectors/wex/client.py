"""WEX API client for fuel transaction polling.
...
class WexClient:
    """Async client for WEX fuel card API."""

    def __init__(self, api_key: str, account_id: str, base_url: str = "https://api.wexinc.com/v1"):
    ...
    async def get_transactions(
        ...
        """Fetch fuel transactions from WEX API.
        ...
        Returns:
            List of transaction dictionaries from WEX API
        """
    ...
    async def get_vehicles(self) -> list[dict[str, Any]]:
        """Fetch all vehicles associated with the WEX account.
