...
connector_healthy = Gauge(
    "mandala_connector_healthy", "Connector health status (1=healthy, 0=unhealthy)", ["connector"]
)

connector_events_published = Counter(
    "mandala_connector_events_published_total", "Total events published by connector", ["connector"]
)

connector_errors = Counter("mandala_connector_errors_total", "Total errors encountered by connector", ["connector"])
